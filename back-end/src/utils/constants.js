...
const MESSAGES = {
  ...
  ERROR_FETCHING_ARTICLE:'Error while fetching article by ID.',
  ...
  ARTICLE_CREATED_SUCCESSFULLY: 'New article was successfully created.',
  ...
  NO_TOKEN: 'No token.',
  WRONG_ADMIN_TOKEN: 'Wrong admin token!',
  ...
  UNAUTHORIZED_TO_DELETE_ARTICLE: 'Unauthorized to delete article.',
  ...
  ERROR_WHILE_UPDATING_ARTICLE: 'Error while updating article.',
  ERROR_WHILE_DELETING_REVIEW: 'Error while deleting review.',
  ERROR_WHILE_DELETING_ARTICLE: 'Error while deleting article.',
